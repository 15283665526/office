...
<div>
    ...
    <el-table-column prop="userAccount" label="操作人账号" width="200" sortable>
    </el-table-column>
		<el-table-column prop="operate" label="操作内容">
		</el-table-column>
    <el-table-column prop="msg" label="操作结果" width="120" sortable>
    </el-table-column>
		<el-table-column prop="createDate" label="操作时间" width="120" sortable>
		</el-table-column>
	</el-table>
...
<script>
import { getOperLog} from '../../api/api'
export default {
	data() {
		return {
			tableData: [],
